public class Main {
    public static void main(String[] args) {
        ...
        float paymentRate = 0.1f;
        int paymentTime = 12;
        float mashaNew = mashaSalary + (mashaSalary * paymentRate);
        float denisNew = denisSalary + (denisSalary * paymentRate);
        float kristinaNew = kristinaSalary + (kristinaSalary * paymentRate);
        float mashaYear = (mashaSalary * paymentRate) * paymentTime;
        float denisYear = (denisSalary * paymentRate) * paymentTime;
        float kristinaYear = (kristinaSalary * paymentRate) * paymentTime;
